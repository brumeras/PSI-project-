...
public class CompatibilityCalculator : InterfaceCompatibilityCalculator
{
    private readonly InterfaceSwipeRepository _swipeRepo;
    
    public CompatibilityCalculator(InterfaceSwipeRepository swipeRepo)
    {
        _swipeRepo = swipeRepo ?? throw new ArgumentNullException(nameof(swipeRepo));
    }
...
>>>>>>> DependencyInjection
    ...
    public PlayerGameStatistics GetPlayerStatistics(string playerUsername, List<CompatibilityScore> allResults)
    {
        ...
        {
            return new PlayerGameStatistics { PlayerUsername = playerUsername };
        }
